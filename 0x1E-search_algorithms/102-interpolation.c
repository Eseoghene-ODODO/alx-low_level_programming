...
#include "search_algos.h" /* include the header file for interpolation_search */
...
int interpolation_search(int *array, size_t size, int value)
{
    ...
    {
        pos = low + (((double)(high - low) / (array[high] - array[low])) * (value - array[low])); /* calculate the probe position */
